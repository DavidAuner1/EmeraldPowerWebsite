...
import ac1 from "@assets/1activepow.png";
import ac2 from "@assets/2activepow.png";
...
export default function ThreePhaseStaticUPS() {
  ...
  const useCases = [
    {
      ...
      description: "Life-critical medical systems and equipment",
      url: "https://mitsubishicritical.com/applications/medical-equipment/",
    },
    {
      icon: "🏢",
      title: "Data Centers",
      description: "High-density server and storage protection",
      url: "https://mitsubishicritical.com/applications/data-centers/",
    },
    {
      icon: "🏭",
      title: "Manufacturing",
      description: "Process control and automation systems",
      url: "https://mitsubishicritical.com/applications/manufacturing/",
    },
    {
      icon: "📡",
    ...
    },
    {
      ...
      description: "Security and mission-critical systems",
    },
    {
      icon: "🔋",
      title: "FESS Applications",
      description: "Flywheel Energy Storage System integration",
    },
  ];
  ...
  const whyChoose = [
    {
      icon: Shield,
      title: "FESS Technology",
      description: "Flywheel Energy Storage for maintenance-free backup power",
    },
    {
      icon: TrendingUp,
      title: "Modular Scalability",
      description: "Expand capacity as your facility grows",
    },
    {
      icon: Battery,
      title: "High Efficiency",
      description: "Advanced power conversion with minimal losses",
    },
    {
      icon: Zap,
      title: "Fast Transfer",
      description: "Seamless power transfer with zero interruption",
    },
  ];
  ...
  const activePowerProducts = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200",
    },
    {
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1581092160607-ee22621dd758?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200",
    },
    {
      name: "PowerHouse UPS",
      powerRange: "1-3 MW",
      ...
      image:
        "https://images.unsplash.com/photo-1497515114629-f71d768fd07c?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200",
    },
    {
      name: "GenStart",
      powerRange: "Variable",
      ...
      image:
        "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Three Phase Static UPS Systems
          </h1>
          <p className="text-xl emerald-green font-semibold mb-6">
            Advanced static power protection with flywheel energy storage.
          </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Three Phase Static UPS systems use advanced power electronics
                  and flywheel energy storage (FESS) to provide clean,
                  uninterrupted power protection. These systems solve power
                  quality issues through double conversion technology while
                  using maintenance-free flywheel backup instead of traditional
                  batteries.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Available in modular configurations from 225 kVA to 3 MW,
                  these systems offer superior efficiency, scalability, and
                  reliability for mission-critical applications requiring the
                  highest levels of power protection and environmental
                  sustainability.
                </p>
              </div>
              <img
        ...
        <Card className="mb-12 shadow-lg">
          <CardContent className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <img
                src={ ac3 }
                alt="9900AEGIS Energy Efficient Three Phase UPS"
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold">
                        Analyze Critical Load Requirements
                      </h4>
                      <p className="text-sm text-gray-600">
                        Detailed power quality assessment and load analysis
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold">
                        Design Optimal Static UPS Solution
                      </h4>
                      <p className="text-sm text-gray-600">
                        Select FESS or battery backup based on application needs
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Active Power and Mitsubishi Critical expertise
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Full installation, testing, and commissioning services
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <CardContent className="p-8">
            <div className="flex items-center mb-6">
              <img
                ...
                className="h-12 mr-4"
              />
              <h2 className="text-3xl font-bold emerald-blue">
                Active Power FESS Solutions
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.activepower.com/product/cleansource-sms-plus-ups/",
                      "_blank",
                    )
                  }
              ...
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.activepower.com/product/cleansource-hd-ups/",
                      "_blank",
                    )
                  }
                  className="w-full text-emerald-blue border-emerald-blue hover:bg-emerald-blue hover:text-white"
        ...
        <Card className="mb-12 shadow-lg">
          <CardContent className="p-8">
            <div className="flex items-center mb-6">
              ...
              />
              <h2 className="text-3xl font-bold emerald-blue">
                Mitsubishi Critical Power Solutions
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <div className="bg-red-50 p-3 rounded-lg mb-4">
                  <p className="text-sm font-semibold text-red-700">
                    Energy Efficient Three Phase UPS
                  </p>
                </div>
                <Button
                  variant="outline"
                  ...
                  onClick={() =>
                    window.open(
                      "https://mitsubishicritical.com/uninterruptible-power-supplies/9900aegis-ups/",
                      "_blank",
                    )
                  }
                  className="w-full text-emerald-blue border-emerald-blue hover:bg-emerald-blue hover:text-white"
              ...
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <h3 className="text-lg font-bold mb-2">
                  Diamond Plus 1100 Series UPS
                </h3>
                <div className="bg-red-50 p-3 rounded-lg mb-4">
                  <p className="text-sm font-semibold text-red-700">
                    Compact, Modular UPS for Server Rooms
                  </p>
                </div>
                <Button
                  variant="outline"
                  ...
                  onClick={() =>
                    window.open(
                      "https://mitsubishicritical.com/uninterruptible-power-supplies/diamond-plus-1100-series-ups/",
                      "_blank",
                    )
                  }
                  className="w-full text-emerald-blue border-emerald-blue hover:bg-emerald-blue hover:text-white"
        ...
        <Card className="mb-12 shadow-lg">
          <CardContent className="p-8">
            <div className="flex items-center mb-6">
              <img src={toshibaLogo} alt="Toshiba" className="h-12 mr-4" />
              <h2 className="text-3xl font-bold emerald-blue">
                Toshiba Power Electronics
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <div className="bg-red-50 p-3 rounded-lg mb-4">
                  <p className="text-sm font-semibold text-red-700">
                    High Performance Three Phase UPS
                  </p>
                </div>
                <Button
                  variant="outline"
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.toshiba.com/tic/power-electronics/uninterruptible-power-systems/three-phase/g9400-series-ups",
                      "_blank",
                    )
                  }
                  className="w-full text-emerald-blue border-emerald-blue hover:bg-emerald-blue hover:text-white"
              ...
              <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.toshiba.com/tic/power-electronics/uninterruptible-power-systems/three-phase/4400-series-3-phase-ups",
                      "_blank",
                    )
                  }
                  className="w-full text-emerald-blue border-emerald-blue hover:bg-emerald-blue hover:text-white"
