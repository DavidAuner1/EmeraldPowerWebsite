...
import lightingInverter3 from "@assets/lightinginverter3_1750055183791.png";
import lightingInverter4 from "@assets/lightinginverter4_1750021707845.png";
import lightingInverter5 from "@assets/Lightinginvert5.png";


const lightingInverter = [
  lightingInverter1,
  lightingInverter2,
  lightingInverter3,
  lightingInverter4,
...
export default function LightingInverters() {
  ...
  const certifications = [
    {
      standard: "UL 924",
      description:
        "Emergency Lighting Equipment and Auxiliary Lighting and Power Equipment",
      runtime:
        "90 minutes standard, alternative runtimes available (15+ minutes)",
      applications: [
        "Emergency egress lighting",
        "Generator-compatible systems",
  ...
  const useCases = [
    {
      icon: "🏥",
      title: "Medical Power",
      description: "Medical-grade lighting systems for healthcare facilities",
    },
    {
      icon: "🚦",
      title: "Traffic Light Backup",
      description: "Battery backup systems for traffic control",
    },
    {
      icon: "🏢",
      title: "Emergency Egress",
      description: "Life safety lighting during power outages",
    },
    {
      icon: "🏭",
      title: "Industrial Facilities",
      description: "Critical area lighting protection",
    },
    {
      icon: "🏛️",
      title: "Government Buildings",
      description: "Security and safety lighting systems",
    },
    {
      icon: "⚡",
      title: "Power Conditioning",
      description: "Clean power for sensitive lighting loads",
    },
  ];
  ...
  const whyChoose = [
    {
      icon: Shield,
      title: "UL Listed Solutions",
      description: "Certified to UL 924, UL 1778, and UL 60601 standards",
    },
    {
      icon: TrendingUp,
      title: "Generator Compatible",
      description: "Seamless integration with backup generators",
    },
    {
      icon: Battery,
      title: "Self-Testing",
      description: "Automated testing and data logging per NFPA 101",
    },
    {
      icon: Lightbulb,
      title: "Versatile Applications",
      description: "Emergency, medical, and traffic lighting solutions",
    },
  ];
  ...
  const products = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1586771107445-d3ca888129ff?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=200",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl emerald-green font-semibold mb-6">
            Critical lighting protection for life safety and emergency
            applications.
          </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  Lighting Inverters are specialized UPS systems designed to
                  provide emergency backup power for critical lighting
                  applications. These systems solve life safety challenges by
                  ensuring continuous illumination during power outages,
                  maintaining emergency egress lighting, and supporting
                  medical-grade lighting requirements.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Certified to UL 924, UL 1778, and UL 60601 standards, these
                  inverters provide reliable power conditioning and backup for
                  emergency lighting, medical facilities, traffic control
                  systems, and other critical lighting applications where
                  uninterrupted operation is essential for safety and
                  compliance.
                </p>
              </div>
              <img
                src={lightingInverter5}
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-6">
              {certifications.map((cert, index) => (
                <div
                  key={index}
                  className="border-l-4 border-emerald-green pl-6 bg-gray-50 p-6 rounded-r-lg"
                >
                  <h3 className="text-xl font-bold mb-2 emerald-green">
                    {cert.standard}
                  </h3>
                  <p className="text-gray-700 mb-3">{cert.description}</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h4 className="font-semibold text-emerald-blue mb-2">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold">
                        Assess Critical Lighting Requirements
                      </h4>
                      <p className="text-sm text-gray-600">
                        Evaluate emergency egress and life safety lighting needs
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold">
                        Select Appropriate UL Listed Solution
                      </h4>
                      <p className="text-sm text-gray-600">
                        Choose UL 924, UL 1778, or UL 60601 certified systems
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold">
                        Source from Trystar/Controlled Power
                      </h4>
                      <p className="text-sm text-gray-600">
                        Leverage proven emergency lighting technology
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
        ...
        <Card className="shadow-lg">
          <CardContent className="p-8">
            ...
            <div className="bg-emerald-green bg-opacity-10 rounded-lg p-6">
              <h3 className="text-xl font-bold mb-4 emerald-green">
                UL 924 Auxiliary Lighting and Power
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-1 text-sm">
                    <li className="flex items-center">
                      <CheckCircle className="h-3 w-3 text-emerald-green mr-2" />
                      90-minute battery runtime standard
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-3 w-3 text-emerald-green mr-2" />
                      Alternative runtimes (15+ minutes) available
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-3 w-3 text-emerald-green mr-2" />
                      Generator compatibility eliminates transfer delay
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-3 w-3 text-emerald-green mr-2" />
                      Self-testing and data logging per NFPA 101
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-1 text-sm">
                    ...
                    <li className="flex items-center">
                      <CheckCircle className="h-3 w-3 text-emerald-green mr-2" />
                      Generator-based emergency lighting
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-3 w-3 text-emerald-green mr-2" />
                      Sensitive electronic lighting loads
                    </li>
                    <li className="flex items-center">
                      <CheckCircle className="h-3 w-3 text-emerald-green mr-2" />
                      Critical always-on lighting circuits
                    </li>
                  </ul>
                </div>
              </div>
